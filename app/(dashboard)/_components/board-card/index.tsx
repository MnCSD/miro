...
export const BoardCard = ({
  ...
  const autorLabel = userId === authorId ? "You" : authorName;
      ...
      <div className="group aspect-[100/127] border rounded-lg flex flex-col justify-between overflow-hidden">
        <div className="relative flex-1 bg-amber-50">
          ...
          <Actions id={id} title={title} side="right">
            <button className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transtion-opacity px-3 py-2 outline-none">
        ...
        <Footer
          ...
          title={title}
          authorLabel={autorLabel}
          createdLabel={createdLabel}
          onClick={toggleFavorite}
          disabled={pendingFavorite || onPendingUnfavorite}
        />
      </div>
    </Link>
  );
